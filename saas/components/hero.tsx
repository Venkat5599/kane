        ...
        >
          ...
          <h1 className="text-8xl max-[850px]:text-5xl font-medium tracking-tight leading-[1.1] mb-6 text-black">
            ...
            <motion.span
              ...
              transition={{ duration: 0.8, ease }}
            >
              Kane <span className="italic font-serif text-accent">checks it.</span>
            </motion.span>
          </h1>
          ...
          >
            ...
            <span className="relative z-10 px-6 py-3 rounded-xl bg-black text-white font-medium max-[850px]:flex-1">See the loop</span>
